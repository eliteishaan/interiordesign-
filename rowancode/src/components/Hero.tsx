    ...
    >
      ...
      >
        ...
        >
          ...
          <h1
            className="font-serif text-[clamp(3.5rem,8.6vw,7.9rem)] font-light leading-[0.9] tracking-[-0.02em] text-white"
            style={{
              textShadow:
          ...
          <motion.p
            ...
            className="mt-8 max-w-md font-sans text-[1rem] font-light leading-relaxed text-white md:mt-10 md:text-[1.0625rem]"
          ...
          >
            <a href="#work" className="hero-cta group">
            ...
            <a
              href="#contact"
              className="border-b border-white/35 pb-0.5 font-sans text-[0.6875rem] uppercase tracking-[0.22em] text-white/85 transition-all duration-400 hover:border-white hover:text-white"
