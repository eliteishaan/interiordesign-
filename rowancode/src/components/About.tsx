    ...
    <section id="studio" ref={ref} className="relative overflow-hidden bg-ivory">
      ...
      <div className="mx-auto max-w-[1600px] px-6 pt-28 md:px-10 md:pt-40 lg:px-16 lg:pt-48">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          <motion.p
            ...
            className="section-label lg:col-span-2"
          >
            The Studio
          </motion.p>
          <div className="lg:col-span-9 lg:col-start-4">
            <h2 className="font-serif text-[clamp(2.1rem,4.8vw,4rem)] font-light leading-[1.12] tracking-[-0.02em] text-charcoal">
              {[
                'A practice built on patience,',
                'craft, and the belief that',
                'homes should feel inevitable.',
              ].map((line, i) => (
      ...
      <div className="relative mx-auto mt-16 max-w-[1600px] px-6 md:mt-24 md:px-10 lg:mt-28 lg:px-16">
        <div className="relative grid grid-cols-12 gap-4 md:gap-6">
          ...
          >
            ...
            <p className="mt-4 section-label !normal-case !tracking-[0.05em] !text-[0.6875rem]">
      ...
      >
        ...
        >
          ...
          <p className="max-w-4xl font-serif text-[clamp(1.5rem,3.4vw,2.85rem)] font-light italic leading-[1.3] tracking-[-0.01em] text-charcoal">
            {[
              'Architecture is the careful framing of life.',
              'Our role is to make that frame so well-considered',
              'that it disappears — leaving only the experience',
              'of being home.',
            ].map((line, i) => (
              <span key={line} className="block overflow-hidden">
                <motion.span
                  className="block"
                  initial={{ y: '110%' }}
                  animate={quoteInView ? { y: '0%' } : {}}
                  transition={{ duration: 1.05, delay: 0.15 + i * 0.08, ease }}
                >
                  {line}
                </motion.span>
              </span>
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-8">
          <div className="grid grid-cols-2 gap-4 md:gap-8 lg:col-span-7">
            {team.map((member, i) => (
              ...
              >
                ...
                <p className="mt-1 section-label !normal-case !tracking-[0.06em] !text-[0.75rem]">
                  {member.role}
                </p>
          ...
          >
            <div>
              ...
              <p className="mt-6 font-sans text-[0.9375rem] font-light leading-[1.9] text-bark">
            ...
            <div className="mt-12 border-t border-soft-line pt-8">
              <p className="font-serif text-3xl font-light text-charcoal md:text-4xl">
                Three cities.
                <br />
